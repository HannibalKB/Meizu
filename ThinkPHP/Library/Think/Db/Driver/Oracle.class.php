...
class Oracle extends Driver{
     ...
     */
     public function getFields($tableName) {
        ...
        $res = $this->query("select a.column_name,data_type,decode(nullable,'Y',0,1) notnull,data_default,decode(a.column_name,b.column_name,1,0) pk "
    ...
    public function getTables($dbName='') {
        $res = $this->query("select table_name from user_tables");
        $info   =   array();
        foreach ($res as $key => $val) {
