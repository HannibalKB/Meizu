...
class MongoModel extends Model{
    ...
    public function distinct($field, $where=array() ){
        ...
        return isset($res['values']) ? $res['values'] : false;
    }
    ...
    protected function _after_select(&$resSet,$options) {
        array_walk($resSet,array($this,'checkMongoId'));
    }
     ...
     * @return array
     */
    protected function checkMongoId(&$res){
        if(is_object($res['_id'])) {
            ...
            if(!empty($resSet)) {
                ...
                foreach ($resSet as $res){
                    ...
                    if(2==$count) {
                        ...
                        $cols[$name]   =  is_null($sepa)?$res:implode($sepa,$res);
                    }
                }
                return $cols;
            }
