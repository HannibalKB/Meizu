 ...
 * This callback function will echo the ress of PHPMailer processing.
 */
 ...
 * @return boolean
 */
function callbackAction($res, $to, $cc, $bcc, $subject, $body)
{
    /*
    this callback example echos the ress to the screen - implement to
    ...
    */
    ...
    echo $res . "\tTo: " . $to['Name'] . "\tTo: " . $to['Email'] . "\tCc: " . $cc['Name'] .
