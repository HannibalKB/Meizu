...
* Some small changes in header formatting to improve IETF msglint test ress
...
* added callback function support
  - callback function parameters include:
    res, to, cc, bcc, subject and body
...
* removed trim() from return ress in EncodeQP
...
* fully compatible with E_STRICT error level
  - Please note:
    ...
    This is NOT a PHPMailer error, it is the res of an incorrectly configured
