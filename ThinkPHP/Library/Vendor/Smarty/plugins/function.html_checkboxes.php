...
function smarty_function_html_checkboxes($params, $template)
{
    ...
    if (isset($options)) {
        foreach ($options as $_key=>$_val) {
            $_html_res[] = smarty_function_html_checkboxes_output($name, $_key, $_val, $selected, $extra, $separator, $labels, $label_ids, $escape);
        }
    } else {
    ...
    if(!empty($params['assign'])) {
        $template->assign($params['assign'], $_html_res);
    } else {
        return implode("\n", $_html_res);
    }
