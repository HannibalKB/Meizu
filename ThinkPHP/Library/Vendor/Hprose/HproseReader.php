...
class HproseSimpleReader extends HproseRawReader {
    ...
    public function &unserialize($tag = NULL) {
        ...
        switch ($tag) {
            ...
            case '9':
                $res = (int)$tag; break;
            case HproseTags::TagInteger: $res = $this->readInteger(); break;
            case HproseTags::TagLong: $res = $this->readLong(); break;
            case HproseTags::TagDouble: $res = $this->readDouble(); break;
            case HproseTags::TagNull: break;
            case HproseTags::TagEmpty: $res = ''; break;
            case HproseTags::TagTrue: $res = true; break;
            case HproseTags::TagFalse: $res = false; break;
            case HproseTags::TagNaN: $res = log(-1); break;
            case HproseTags::TagInfinity: $res = $this->readInfinity(); break;
            case HproseTags::TagDate: $res = $this->readDate(); break;
            case HproseTags::TagTime: $res = $this->readTime(); break;
            case HproseTags::TagBytes: $res = $this->readBytes(); break;
            case HproseTags::TagUTF8Char: $res = $this->readUTF8Char(); break;            
            case HproseTags::TagString: $res = $this->readString(); break;
            case HproseTags::TagGuid: $res = $this->readGuid(); break;
            case HproseTags::TagList: $res = &$this->readList(); break;
            case HproseTags::TagMap: $res = &$this->readMap(); break;
            case HproseTags::TagClass: $this->readClass(); $res = &$this->unserialize(); break;
            case HproseTags::TagObject: $res = $this->readObject(); break;
