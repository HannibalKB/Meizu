...
<body>
<div class="pd-20">
  <form class="Huiform" id="form-role-add" action="<?php echo U('admin/role/addrole');?>" method="post">
    <table class="table table-border table-bordered table-bg">
      <tbody>
        <tr>
          <th class="text-r" width="70px">角色名称：</th>
          <td><input name="title" type="text" class="input-text" id="rolenames"  datatype="*1-20" nullmsg="角色名称不能为空！"> 
          </td>
        </tr>
        <tr>
          ...
          <td>
            <table class="table table-border table-bordered table-bg">
              ...
              <?php  foreach ($res as $key => $value) { ?>
                    <tr>
                      ...
                      <td class="permission-list">
                        ...
                        <div class="cl">
                        <?php  foreach ($value['cate'] as $k => $v) { ?>
                              <label class="item" style="width:150px;"><input name="id[]" type="checkbox" value="<?php echo $v['id'] ?>"> <?php echo $v['title'] ?></label>
                            <?php
 } ?>
              ...
              <tr>
                ...
                <td><textarea name="desc" class="textarea" id="desc"  placeholder="描述下角色所具有的权限"></textarea> 
                </td>
              </tr>
