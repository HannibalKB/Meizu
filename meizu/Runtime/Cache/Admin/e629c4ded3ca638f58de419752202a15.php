...
<body>
<div class="pd-20">
  <form action="<?php echo U('admin/shoptypeattr/editattr');?>" method="post" class="form form-horizontal" id="form-user-add">
  <input type="hidden" name="attr_id" value="<?php echo $_GET['attr_id'] ?>">
 ...
 foreach ($Typerres as $key => $value) { ?>
                  <option 
                    <?php  if($value['type_id'] == $res[0]['type_id']) echo 'selected' ?>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $res[0]['attr_name'] ?>" placeholder="类别属性名称" id="attr_name" name="attr_name" >
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<?php echo $res[0]['attr_value'] ?>" placeholder="类别属性值" name="attr_value" id="attr_value">
      </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5"> <span class="select-box">
         <select class="select" name="isbeselected" size="1" id="isbeselected">
            <option value="0" <?php if($res[0]['isbeselected']==0) echo 'selected' ?>>否</option>
            <option value="1" <?php if($res[0]['isbeselected']==1) echo 'selected' ?>>是</option>
        </select>
        </span> 
      </div>
      <div class="col-4"> </div>
