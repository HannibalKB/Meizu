...
<img src="/mz/Public/Index/img/left.png" alt="" style="inline-block;margin-left:-350px;position:absolute;">
   <form id="mainForm" enctype="application/x-www-form-urlencoded" method="post" action="<?php echo U('home/login/allowPhonelogin');?>" > 
    <div class="number"> 
     <a class="linkAGray" id="toAccountLogin" href="<?php echo U('home/login/index');?>">普通登录</a> 
     <span class="register-line"></span> 
     <a class="linkABlue" id="toVCodeLogin" href="javascript:;">手机登录</a> 
    </div> 
    <div class="normalInputself cycode-box fieldInput" id="cycode-box" style="margin-bottom:12px" > 
      <input class="selfinputclass" name="phone" id="phone" maxlength="50" placeholder="手机号"  /> 
    </div>
    ...
    <input type="submit" name="login" class="denglu" value="登录">
