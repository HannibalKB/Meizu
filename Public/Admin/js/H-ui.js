...
$(function(){
	...
	$.Huihover('.ac_ress li');
	$(".ac_ress li").click(function (event){
	...
	$(".searchTxt").focus(function(){$(".ac_ress").show();return false;});
	$(".ac_ress").blur(function(){$(this).hide();});
	$("body").click(function(){$(".ac_ress").hide();});
	$(".searchTxt").click(function(){$(".ac_ress").show();return false;});
