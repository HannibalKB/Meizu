            ...
            if (bCheck == true) {
                ...
                if (zuheDate.length > 0) {
                    ...
                    $.each(zuheDate, function (index, item) {
                        ...
                        var td1 = $("<td ><input name=\"good_price[]\"  class=\"l-text\" type=\"text\" value=\"\"></td>");
                        td1.appendTo(tr);
                        var td2 = $("<td ><input name=\"good_stock[]\" class=\"l-text\" type=\"text\" value=\"\"><input type=\"hidden\"  name=\"shopsku[]\" value="+item+"></td>");
                        td2.appendTo(tr);
