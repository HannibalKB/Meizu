...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        function scrollIntoView(x1, y1, x2, y2) {
            ...
            var screen = scroller.clientHeight, screentop = scroller.scrollTop, scrolled = false, res = true;
            ...
            if (x1 < screenleft + gutterw) {
                ...
                scrolled = true;
                if (x2 > code.clientWidth) res = false;
            }
        ...
        function operation(f) {
            return function() {
                ...
                try {var res = f.apply(this, arguments);}
    ...
    var splitLines = "\n\nb".split(/\n/).length != 3 ? function(string) {
        ...
        while ((nl = string.indexOf("\n", pos)) > -1) {
            res.push(string.slice(pos, string.charAt(nl-1) == "\r" ? nl - 1 : nl));
            pos = nl + 1;
        }
        res.push(string.slice(pos));
        return res;
